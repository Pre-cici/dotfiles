# Generated by Powerlevel10k configuration wizard on 2025-11-14 at 01:21 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_ANACONDA_FOREGROUND=110
  ...
  ##########[ nodenv: node.js version from nodenv (https://github.com/nodenv/nodenv) ]##########
  # Nodenv color.
  typeset -g POWERLEVEL9K_NODENV_FOREGROUND=195
  ...
  ##############[ nvm: node.js version from nvm (https://github.com/nvm-sh/nvm) ]###############
  # Nvm color.
  typeset -g POWERLEVEL9K_NVM_FOREGROUND=115
