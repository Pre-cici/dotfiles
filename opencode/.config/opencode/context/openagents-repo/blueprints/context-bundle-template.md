...
**Core Standards**:
- `/Users/hsp/.config/opencode/context/core/standards/code-quality.md` → Modular, functional code patterns
- `/Users/hsp/.config/opencode/context/core/standards/test-coverage.md` → Testing requirements and TDD
- `/Users/hsp/.config/opencode/context/core/standards/documentation.md` → Documentation standards
- `/Users/hsp/.config/opencode/context/core/standards/security-patterns.md` → Error handling, security patterns

**Core Workflows**:
- `/Users/hsp/.config/opencode/context/core/workflows/task-delegation-basics.md` → Delegation process
- `/Users/hsp/.config/opencode/context/core/workflows/feature-breakdown.md` → Task breakdown methodology
- `/Users/hsp/.config/opencode/context/core/workflows/code-review.md` → Code review guidelines

## Repository-Specific Context (Load These Before Starting)

**Quick Start** (ALWAYS load first):
- `/Users/hsp/.config/opencode/context/openagents-repo/quick-start.md` → Repo orientation and common commands

**Core Concepts** (Load based on task type):
- `/Users/hsp/.config/opencode/context/openagents-repo/core-concepts/agents.md` → How agents work
- `/Users/hsp/.config/opencode/context/openagents-repo/core-concepts/evals.md` → How testing works
- `/Users/hsp/.config/opencode/context/openagents-repo/core-concepts/registry.md` → How registry works
- `/Users/hsp/.config/opencode/context/openagents-repo/core-concepts/categories.md` → How organization works

**Guides** (Load for specific workflows):
- `/Users/hsp/.config/opencode/context/openagents-repo/guides/adding-agent-basics.md` → Step-by-step agent creation
- `/Users/hsp/.config/opencode/context/openagents-repo/guides/testing-agent.md` → Testing workflow
- `/Users/hsp/.config/opencode/context/openagents-repo/guides/updating-registry.md` → Registry workflow
- `/Users/hsp/.config/opencode/context/openagents-repo/guides/debugging.md` → Troubleshooting

**Lookup** (Quick reference):
- `/Users/hsp/.config/opencode/context/openagents-repo/lookup/file-locations.md` → Where everything is
- `/Users/hsp/.config/opencode/context/openagents-repo/lookup/commands.md` → Command reference
...
2. **Copy template**:
   ```bash
   cp /Users/hsp/.config/opencode/context/openagents-repo/templates/context-bundle-template.md \
...
See `/Users/hsp/.config/opencode/context/openagents-repo/examples/context-bundle-example.md` for a complete example.
