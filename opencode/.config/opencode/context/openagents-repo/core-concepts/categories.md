...
/Users/hsp/.config/opencode/context/development/
├── navigation.md
├── clean-code.md
├── react-patterns.md
└── api-design.md
...
mkdir -p /Users/hsp/.config/opencode/context/{category}
...
```bash
cat > /Users/hsp/.config/opencode/context/{category}/navigation.md << 'EOF'
...
```
/Users/hsp/.config/opencode/context/{category}/
...
Loads: `/Users/hsp/.config/opencode/context/ui/web/react-patterns.md`
