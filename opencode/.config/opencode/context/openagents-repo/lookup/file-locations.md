...
| **Context files** | `/Users/hsp/.config/opencode/context/` |
...
| **New context** | `/Users/hsp/.config/opencode/context/{category}/{name}.md` |
...
```
/Users/hsp/.config/opencode/context/{category}/{topic}.md
```

**Examples**:
- `/Users/hsp/.config/opencode/context/core/standards/code-quality.md`
- `/Users/hsp/.config/opencode/context/ui/web/react-patterns.md`
- `/Users/hsp/.config/opencode/context/content-creation/principles/copywriting-frameworks.md`
...
```bash
# By category
ls /Users/hsp/.config/opencode/context/{category}/

# All context
find /Users/hsp/.config/opencode/context -name "*.md"
```
