...
- Answer is in `/Users/hsp/.config/opencode/context/` (use ContextScout instead)
...
- **External Context Management**: `/Users/hsp/.config/opencode/context/core/workflows/external-context-management.md`
- **Task Delegation**: `/Users/hsp/.config/opencode/context/core/workflows/task-delegation-basics.md`
