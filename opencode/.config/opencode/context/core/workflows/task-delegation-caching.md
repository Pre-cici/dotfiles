...
├── .cache/
│   ├── test-coverage.md (cached from /Users/hsp/.config/opencode/context/)
│   ├── code-quality.md
│   └── code-review.md
...
```json
{
  ...
  "cache": {
    "test-coverage.md": {
      "source": "/Users/hsp/.config/opencode/context/core/standards/test-coverage.md",
...
IF cache exists AND cache is valid:
  ...
  SKIP re-reading from /Users/hsp/.config/opencode/context/
ELSE:
  READ from /Users/hsp/.config/opencode/context/
  CACHE the file
```
