...
```bash
npx ts-node /Users/hsp/.config/opencode/context/tasks/scripts/task-cli.ts <command> [args]
```
...
See `/Users/hsp/.config/opencode/context/core/workflows/multi-stage-orchestration.md` for the complete workflow.
